 ...
 <?php 
      ...
      <?php
        if(mysqli_num_rows($result)>0) {
          ...
          $_SESSION["NamaLengkap"] = $d_user["NamaLengkap"];
          $_SESSION["Username"] = $d_user["Username"];
          $_SESSION["Email"] = $d_user["Email"];
          $_SESSION["Alamat"] = $d_user["Alamat"];
        }
      ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <div class="container">
   ...
   <div class="main-content">
    <div class="form-control">
     ...
     <input type="text" disabled name="NamaLengkap" value="<?php echo $_SESSION['NamaLengkap']?>" class="form-control">
    </div>

    <div class="form-control">
     <label>Username</label>
     <input type="text" disabled name="Username" value="<?php echo $_SESSION['Username']?>" class="form-control">
    </div>
    <div class="form-control">
     <label>Email</label>
     <input type="text" disabled name="Email" value="<?php echo $_SESSION['Email']?>" class="form-control">
    </div>
    <div class="form-control">
     <label>Alamat</label>
     <input type="text" disabled name="Alamat" value="<?php echo $_SESSION['Alamat']?>" class="form-control">
    </div>
   </div>
  </div>
