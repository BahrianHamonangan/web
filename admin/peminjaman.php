  ...
  <div class="main-content">
    <div class="card-body">
        <table class="table">
            ...
            <tbody>
                <?php
                $sql2 = "SELECT u.Username, b.Judul, p.TanggalPeminjaman, 
                p.TanggalPengembalian, p.StatusPeminjaman
                            FROM peminjaman p
                ...
                while ($r2 = mysqli_fetch_array($q2)) {
                    ...
                    $Judul = $r2['Judul'];
                    $TanggalPeminjaman = $r2['TanggalPeminjaman'];
                    $TanggalPengembalian = $r2['TanggalPengembalian'];
                    $StatusPeminjaman = $r2['StatusPeminjaman'];  ?>
                    <tr>
                        <td><?php echo $Username ?></td>
                        <td><?php echo $Judul ?></td>
                        <td><?php echo $TanggalPeminjaman ?></td>
                        <td><?php echo $TanggalPengembalian ?></td>
                        <td><?php echo $StatusPeminjaman ?></td>
                    </tr>
                <?php } ?>
            </tbody>
        </table>
