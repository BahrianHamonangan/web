...
if (isset($_POST['simpan'])) {
  ...
  if($BukuID && $Judul && $Penulis && $Penerbit && $TahunTerbit){
    if($op == 'edit'){//update data
      ...
      ,Penerbit='$Penerbit',TahunTerbit='$TahunTerbit' where BukuID='$BukuID'";
      $q1        = mysqli_query($koneksi,$sql1);
      if($q1){
...
<body>
  ...
  <div class="card-body">
    ...
    <div class="col-sm-10">
      <input type="date" class="form-control" id="TahunTerbit" name="TahunTerbit" value="<?php echo $TahunTerbit ?>">
    </div>
    </div>
  </div>
  <div class="col-12">
        ...
        <tbody>
          ...
          while($r2 = mysqli_fetch_array($q2)){
            ...
            <tr>
              ...
              <a href="buku.php?op=delete&BukuID=<?php echo $BukuID?>" onclick="return 
