...
<body>
  <div class="container">
    <div class="sidebar">
      ...
      <!-- End -->
      <script src="../admin/navbar.php"></script>
  <!-- Masukkan -->
  ...
  <div class="card-body">
    <?php
      if($error){
        ...
        <?php  
        header("refresh:3;url=login.php"); //3 detik
      }
      ?>
      <?php
      if ($succes) {
        ...
        <tbody>
          ...
          while($r2 = mysqli_fetch_array($q2)){
            ...
            <tr>
              ...
              <td scope="row">
               <a href="login.php?op=edit&BiodataID=<?php echo $r2['BiodataID']?>">
                <button type="button" class="btn btn-danger">EDIT</button>          
              </a> 
              <a href="login.php?op=delete&BiodataID=<?php echo $r2['BiodataID']?>" onclick="return confirm('Yakin mau HAPUS?')">
